...
const Testimonials = () => {
  return (
    <div className="flex flex-col justify-center items-center lg:mt-28 gap-12 bg-sky-100 py-12 lg:py-28">
        <div className="flex flex-col gap-2 items-center justify-center">
            <p className="text-base lg:text-xl font-extrabold text-[#0860B3]">TESTIMONIALS</p>
