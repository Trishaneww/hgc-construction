    ...
    <div className="flex flex-col items-center justify-center bg-slate-900 text-slate-50 overflow-hidden">
      <div className="flex flex-col lg:flex-row items-center justify-center w-full lg:py-28">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/#estimate"><Button className="w-[290px] h-[50px] lg:h-[60px] lg:w-[310px] text-sm lg:text-base bg-[#0860B3] hover:bg-white hover:text-slate-950 mt-6">FREE ESTIMATE & CONSULTATION</Button></Link>
        </section>
      </div>
      ...
      <div className="flex flex-col lg:flex-row w-full justify-center items-center py-12 gap-10 lg:gap-20 px-4 bg-slate-100">
        <Image
          ...
          height={600}
          alt="homepage image" 
          className="lg:-ml-10 ml-0 lg:mt-0 max-w-[250px] lg:max-w-[420px]"
        />

        <section className="flex flex-col gap-2 lg:w-1/3 xl:w-[40%] text-center lg:text-left text-black lg:mt-2">
          <p className="hidden lg:flex font-bold text-3xl lg:text-4xl">Welcome to HGConstruction</p>
          ...
          <div className="flex flex-col items-start w-full lg:w-[270px]">
              <Input type="email" placeholder="Email" name="email" className="w-full lg:w-[310px] h-[52px] lg:h-[60px] text-lg border-2 bg-white border-white text-black"/>
              <p className="ml-1 text-red-600">{error}</p>
          </div>
          <Button type="submit" className="w-full h-[50px] lg:h-[60px] lg:w-[310px] text-base shadow">FREE ESTIMATE & CONSULTATION</Button>
        </form>
        </section>
      </div>
